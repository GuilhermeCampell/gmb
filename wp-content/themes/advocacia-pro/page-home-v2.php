...
<main id="primary" class="site-main tp-home-main">
    ...
    <div class="tp-hero">
        ...
        <div class="tp-hero__container tp-hero__container--split">
            <div class="tp-hero-content">
                ...
                <div class="tp-hero-actions" style="margin-top:20px;">
                    <a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="tp-btn tp-btn--pill">Discover Our Services</a>
                </div>
            </div>
            
            <div class="tp-hero-widget">
                <div class="tp-hero-widget__inner">
                    <h3>Start Your Journey</h3>
                    <p>Let us know your destination and objectives.</p>
                    <form action="<?php echo esc_url( home_url( '/contact/' ) ); ?>" method="GET" class="tp-quick-form">
                        <div class="tp-quick-form__group">
                            <label>Where (Destination)</label>
                            <input type="text" name="destination" placeholder="e.g., United States" required>
                        </div>
                        <div class="tp-quick-form__group">
                            <label>Objective (Visa Type)</label>
                            <input type="text" name="objective" placeholder="e.g., Investment, Work" required>
                        </div>
                        <button type="submit" class="tp-btn tp-btn--primary" style="width:100%;">Assess My Profile →</button>
                    </form>
                </div>
            </div>
        </div>
